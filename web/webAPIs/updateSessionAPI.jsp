...
<%
    ...
    if (jsonInsertData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            System.out.println("updateSessionAPI.jsp ready to update");
            ...
            errorMsgs = view.WebUserView.updateCampaignSessionAPI(dbc, updateData); // this is the form level message
        }
    }
