...
<%
    ...
    if (id == null) {
        ...
        System.out.println("jsonInsertData is " + id);
        errorMsgs.errorMsg = dbc.getErr();
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            System.out.println("deleteUserAPI.jsp ready to delete");      
            ...
            errorMsgs = WebUserView.deleteUserAPI(dbc, id); // this is the form level message
        }
    }
